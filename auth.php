 ...
 */
$provider = new AmoCRM([
  'clientId' => '26b7d81c-df7b-461c-8d89-a26837191855',
  'clientSecret' => 'owjNsRqCxDiCLUj1hxU3UCmiVEA3jPt9Ki8nS1q23DSjDlgwExgtOjhjt8jccACG',
  'redirectUri' => 'https://parmonov98.uz/apis/amocrm/auth.php',
]);
...
if (!isset($_GET['request'])) {
  if (!isset($_GET['code'])) {
    ...
    if (true) {
      echo '<div>
  <script class="amocrm_oauth" charset="utf-8" data-client-id="' . $provider->getClientId() . '" data-title="Установить интеграцию" data-compact="false" data-class-name="className" data-color="default" data-state="' . $_SESSION['oauth2state'] . '" data-error-callback="handleOauthError" src="https://www.amocrm.ru/auth/button.min.js"></script>
</div>';
      echo '<script>
  ...
  printf('Hello, %s!', $ownerDetails->getName() . '<br/><a href="/apis/amocrm/create.php">создать задачи всем</a>');
} else {
